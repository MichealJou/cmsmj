...
import com.mj.common.persistence.Page;
import com.mj.common.persistence.Parameter;
import com.mj.common.util.Reflections;
...
public class BaseDao<T> {
	...
	@SuppressWarnings("unchecked")
	public <T> List<T> createQuery(String hql ,Object...value){
